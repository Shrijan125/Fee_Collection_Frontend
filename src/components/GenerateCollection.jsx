...
const GenerateCollection = () => {
  ...
  async function onClick()
  {
    ...
    {
      toast.error('Please Select the mandatory fields',{position:'top-right'});
      return;
    }
    try {
      const url = BASE_URL + `/admin/generateCollection?startDate=${startDate.toISOString()}&endDate=${endDate.toISOString()}`;
  ...
  return <div className='flex flex-col items-center justify-center w-screen h-screen gap-5 ml-96 bg-dark'>
